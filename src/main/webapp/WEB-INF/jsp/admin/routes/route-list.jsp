...
<body>
  <main class="container content-box">
    ...
    <div class="d-flex justify-content-between mb-3">
      <a href="/admin/routes/new" class="btn btn-success">Add New Route</a>
    ...
    <table class="table table-striped table-hover">
      <thead class="table-dark">
        <tr>
          <th>ID</th><th>From</th><th>To</th><th>Distance</th><th>Actions</th>
        </tr>
      </thead>
      <tbody>
        <c:forEach var="r" items="${routes}">
          <tr>
            ...
            <td>${r.distance}</td>
            <td>
              <a href="/admin/routes/edit/${r.routeId}" class="btn btn-primary btn-sm">Edit</a>
  ...
  <!-- ✅ Footer -->
  <footer>
    © 2026 Bus Reservation System | Manage Routes
  </footer>
